...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMove(to view: SKView) {
        ...
        ballsLeftLabel.position = CGPoint(x: 1024/2, y: 700)
        ...
        if let touch = touches.first {
            ...
            if objects.contains(editLabel) {
                ...
                if editingMode {
                    ...
                    if ballsLeft > 0 {
                        let ball = SKSpriteNode(imageNamed: ["ballRed", "ballBlue", "ballYellow", "ballPurple", "ballGrey", "ballCyan", "ballGreen"].randomElement()!)
    ...
    func didBegin(_ contact: SKPhysicsContact) {
        ...
        if contact.bodyA.node?.name == "ball" {
            collisionBetween(ball: contact.bodyA.node!, and: nodeB)
        } else {
            collisionBetween(ball: contact.bodyB.node!, and: nodeA)
        }
    }
}
