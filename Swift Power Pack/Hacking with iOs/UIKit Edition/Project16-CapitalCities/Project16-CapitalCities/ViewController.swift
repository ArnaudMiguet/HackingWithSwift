...
//
//  Created by Arnaud Miguet on 12.01.21.
//
...
class ViewController: UIViewController, MKMapViewDelegate {
    ...
    @objc func pickMapType() {
        let ac = UIAlertController(title: "Choose the map type", message: nil, preferredStyle: .alert)
        ac.addAction(UIAlertAction(title: "Navigation", style: .default) { [weak self] action in
